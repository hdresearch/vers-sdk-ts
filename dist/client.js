...
var _Vers_instances, _a, _Vers_encoder, _Vers_baseURLOverridden;
...
const vm_1 = require("./resources/vm.js");
...
class Vers {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('VERS_BASE_URL'), apiKey = (0, env_1.readEnv)('VERS_API_KEY') ?? null, ...opts } = {}) {
        _Vers_instances.add(this);
        _Vers_encoder.set(this, void 0);
        this.vm = new API.VmResource(this);
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('VERS_LOG'), "process.env['VERS_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Vers_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.VersError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Vers_instances, "m", _Vers_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Vers_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Vers = Vers;
_a = Vers, _Vers_encoder = new WeakMap(), _Vers_instances = new WeakSet(), _Vers_baseURLOverridden = function _Vers_baseURLOverridden() {
    return this.baseURL !== 'https://api.vers.sh';
};
Vers.Vers = _a;
Vers.DEFAULT_TIMEOUT = 60000; // 1 minute
Vers.VersError = Errors.VersError;
Vers.APIError = Errors.APIError;
Vers.APIConnectionError = Errors.APIConnectionError;
Vers.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Vers.APIUserAbortError = Errors.APIUserAbortError;
Vers.NotFoundError = Errors.NotFoundError;
Vers.ConflictError = Errors.ConflictError;
Vers.RateLimitError = Errors.RateLimitError;
Vers.BadRequestError = Errors.BadRequestError;
Vers.AuthenticationError = Errors.AuthenticationError;
Vers.InternalServerError = Errors.InternalServerError;
Vers.PermissionDeniedError = Errors.PermissionDeniedError;
Vers.UnprocessableEntityError = Errors.UnprocessableEntityError;
Vers.toFile = Uploads.toFile;
Vers.VmResource = vm_1.VmResource;
