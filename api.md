...
- <code><a href="./src/resources/api/vm.ts">VmCreateBranchResponse</a></code>
...
- <code title="patch /api/vm/{vm_id}">client.api.vm.<a href="./src/resources/api/vm.ts">update</a>(vmID, { ...params }) -> VmUpdateResponse</code>
...
- <code title="post /api/vm/{vm_id}/branch">client.api.vm.<a href="./src/resources/api/vm.ts">createBranch</a>(vmID, { ...params }) -> VmCreateBranchResponse</code>
