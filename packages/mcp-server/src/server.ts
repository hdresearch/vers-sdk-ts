...
import { ClientOptions } from 'vers';
...
export { ClientOptions } from 'vers';
...
export function initMcpServer(params: {
  ...
  const client = new Vers(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Vers({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
