...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/api/vm/{vm_id_or_alias}/branch',
...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    required: ['vm_id_or_alias'],
  },
};

export const handler = async (client: Vers, args: Record<string, unknown> | undefined) => {
  const { vm_id_or_alias, ...body } = args as any;
  return asTextContentResult(await maybeFilter(args, await client.api.vm.branch(vm_id_or_alias, body)));
};
